...
enum mfc_mb_flag {
    ...
    MFC_FLAG_HDR_CONTENT_LIGHT      = 0x1 << 0,
    MFC_FLAG_HDR_DISPLAY_COLOUR     = 0x1 << 1,
    MFC_FLAG_HDR_MAXTIX_COEFF       = 0x1 << 2,
    MFC_FLAG_HDR_COLOUR_DESC        = 0x1 << 3,
    MFC_FLAG_HDR_VIDEO_SIGNAL_TYPE  = 0x1 << 4,
    MFC_FLAG_BLACKBAR_DETECT        = 0x1 << 5,
    MFC_FLAG_HDR_PLUS               = 0x1 << 6,
    MFC_FLAG_DISP_RES_CHANGE        = 0x1 << 7,
    MFC_FLAG_UNCOMP                 = 0x1 << 8,
    MFC_FLAG_FRAMERATE_CH           = 0x1 << 9,
    MFC_FLAG_IDR                    = 0x1 << 10,
    MFC_FLAG_AV1_FILM_GRAIN         = 0x1 << 11,
    MFC_FLAG_MULTIFRAME             = 0x1 << 12,
    /* Driver set to user when SRC DQbuf */
    MFC_FLAG_CONSUMED_ONLY          = 0x1 << 15,
    /* User set to driver when SRC Qbuf */
    MFC_FLAG_ENC_SRC_VOTF           = 0x1 << 26,
    MFC_FLAG_ENC_SRC_FAKE           = 0x1 << 27,
    MFC_FLAG_ENC_SRC_UNCOMP         = 0x1 << 28,
    MFC_FLAG_CSD                    = 0x1 << 29,
    MFC_FLAG_EMPTY_DATA             = 0x1 << 30,
    MFC_FLAG_LAST_FRAME             = 0x1 << 31,
};
...
#define V4L2_CID_MPEG_VIDEO_FRAME_POC (V4L2_CID_MPEG_MFC_BASE + 29)
...
#define V4L2_CID_MPEG_VIDEO_GDC_VOTF (V4L2_CID_MPEG_MFC_BASE + 32)
#define V4L2_CID_MPEG_VIDEO_FRAME_ERROR_TYPE (V4L2_CID_MPEG_MFC_BASE + 33)
#define V4L2_CID_MPEG_VIDEO_AVERAGE_QP (V4L2_CID_MPEG_MFC_BASE + 34)
#define V4L2_CID_MPEG_VIDEO_GOP_CTRL (V4L2_CID_MPEG_MFC_BASE + 35)
#define V4L2_CID_MPEG_VIDEO_PRIORITY (V4L2_CID_MPEG_MFC_BASE + 36)
#define V4L2_CID_MPEG_VIDEO_MAX_IFRAME_SIZE (V4L2_CID_MPEG_MFC_BASE + 37)
...
#define V4L2_CID_MPEG_VIDEO_GET_DISPLAY_DELAY (V4L2_CID_MPEG_MFC_BASE + 40)
...
#define V4L2_CID_MPEG_VIDEO_SKIP_LAZY_UNMAP (V4L2_CID_MPEG_MFC_BASE + 185)
#define V4L2_CID_MPEG_VIDEO_MIN_QUALITY (V4L2_CID_MPEG_MFC_BASE + 186)
...
#define V4L2_CID_MPEG_VIDEO_MV_SEARCH_MODE (V4L2_CID_MPEG_MFC_BASE + 233)
#define V4L2_CID_MPEG_VIDEO_MV_HOR_POSITION_L0 (V4L2_CID_MPEG_MFC_BASE + 234)
#define V4L2_CID_MPEG_VIDEO_MV_HOR_POSITION_L1 (V4L2_CID_MPEG_MFC_BASE + 235)
#define V4L2_CID_MPEG_VIDEO_MV_VER_POSITION_L0 (V4L2_CID_MPEG_MFC_BASE + 236)
#define V4L2_CID_MPEG_VIDEO_MV_VER_POSITION_L1 (V4L2_CID_MPEG_MFC_BASE + 237)
#define V4L2_CID_MPEG_MFC_AV1_FILM_GRAIN_USER_SHARED_HANDLE (V4L2_CID_MPEG_MFC_BASE + 240)
#define V4L2_CID_MPEG_MFC_HDR10_PLUS_STAT_USER_SHARED_HANDLE (V4L2_CID_MPEG_MFC_BASE + 242)
#define V4L2_CID_MPEG_MFC_HDR10_PLUS_STAT_ENABLE (V4L2_CID_MPEG_MFC_BASE + 243)
#endif
