 ...
 */
#ifndef EXYNOS_C2_HEVCDEC_COMPONENT_H
#define EXYNOS_C2_HEVCDEC_COMPONENT_H
...
class ExynosC2HevcDecComponent : public ExynosC2DecComponent/*, public std::enable_shared_from_this<ExynosC2HevcDecComponent>*/ {
public:
    class HevcDecParamIntf;

    ExynosC2HevcDecComponent(c2_node_id_t id, const std::shared_ptr<HevcDecParamIntf> &intfImpl);

    ~ExynosC2HevcDecComponent() {
        mParamIntf.reset();
    }

    /* add function for ExynosC2HevcDecComponent */
...
private:
    ...
    ExynosC2HevcDecComponent() = delete;
};
...
#endif // EXYNOS_C2_HEVCDEC_COMPONENT_H
