 ...
 */
#ifndef EXYNOS_C2_VP8DEC_COMPONENT_H
#define EXYNOS_C2_VP8DEC_COMPONENT_H
...
class ExynosC2Vp8DecComponent : public ExynosC2DecComponent/*, public std::enable_shared_from_this<ExynosC2Vp8DecComponent>*/ {
public:
    class Vp8DecParamIntf;

    ExynosC2Vp8DecComponent(c2_node_id_t id, const std::shared_ptr<Vp8DecParamIntf> &intfImpl);

    ~ExynosC2Vp8DecComponent() {
        mParamIntf.reset();
    }

    /* add function for ExynosC2Vp8DecComponent */
...
private:
    ...
    ExynosC2Vp8DecComponent() = delete;
};
...
#endif // EXYNOS_C2_VP8DEC_COMPONENT_H
