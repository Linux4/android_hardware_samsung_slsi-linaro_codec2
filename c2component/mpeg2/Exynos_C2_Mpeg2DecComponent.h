 ...
 */
#ifndef EXYNOS_C2_MPEG2DEC_COMPONENT_H
#define EXYNOS_C2_MPEG2DEC_COMPONENT_H
...
class ExynosC2Mpeg2DecComponent : public ExynosC2DecComponent/*, public std::enable_shared_from_this<ExynosC2Mpeg2DecComponent>*/ {
public:
    class Mpeg2DecParamIntf;

    ExynosC2Mpeg2DecComponent(c2_node_id_t id, const std::shared_ptr<Mpeg2DecParamIntf> &intfImpl);

    ~ExynosC2Mpeg2DecComponent() {
        mParamIntf.reset();
    }

    /* add function for ExynosC2Mpeg2DecComponent */
...
private:
    ...
    ExynosC2Mpeg2DecComponent() = delete;
};
...
#endif // EXYNOS_C2_MPEG2DEC_COMPONENT_H
