 ...
 */
#include "Exynos_C2_Mpeg4DecComponent.h"
...
#include "ExynosLog.h"
#undef LOG_TAG
#define LOG_TAG "ExynosC2Mpeg4DecComponent"

constexpr char COMPONENT_NAME[] = "c2.exynos.mpeg4.decoder";
...
ExynosC2FilterManager::FilterModuleInfoList listFilterInfo = {
    {   "mpeg4dec",
        &ExynosC2FilterManager::FilterModule::makeFilterModule<ExynosMpeg4DecFilter>,
...
class ExynosC2Mpeg4DecComponent::Mpeg4DecParamIntf : public ExynosC2DecComponent::VdecCommonParamIntf {
public:
    Mpeg4DecParamIntf(const std::shared_ptr<C2ReflectorHelper> &helper)
        : VdecCommonParamIntf(
                helper,
                COMPONENT_NAME,
    ...
    virtual ~Mpeg4DecParamIntf() = default;

    /* getter functions */

private:
    friend class ExynosC2Mpeg4DecComponent;
};

ExynosC2Mpeg4DecComponent::ExynosC2Mpeg4DecComponent(c2_node_id_t id, const std::shared_ptr<Mpeg4DecParamIntf> &intfImpl)
    : ExynosC2DecComponent(std::make_shared<ExynosC2ComponentInterface>(COMPONENT_NAME, id, intfImpl)) {

    mObjName    = "ExynosC2Mpeg4DecComponent";
    mbLogOff    = false;
...
bool ExynosC2Mpeg4DecComponent::init(std::weak_ptr<C2Component> wkComponent) {
...
void ExynosC2Mpeg4DecComponent::onUpdateC2Config(
    ...
    auto mpeg4DecIntf = std::static_pointer_cast<Mpeg4DecParamIntf>(mParamIntf);
...
c2_status_t ExynosC2Mpeg4DecComponent::onSetup() {
    ExynosLogFunctionTrace();
    ...
    mpeg4DecIntf->addStreamCrop(2048, 2048);
...
class ExynosC2Mpeg4DecFactory : public C2ComponentFactory {
public:
    ExynosC2Mpeg4DecFactory()
    ...
    c2_status_t createComponent(
        ...
        using __component_type = ExynosC2ComponentWrapper<ExynosC2Mpeg4DecComponent,
                                                          ExynosC2Mpeg4DecComponent::Mpeg4DecParamIntf>;

        *component = std::shared_ptr<C2Component>(
                        new __component_type(id, std::make_shared<ExynosC2Mpeg4DecComponent::Mpeg4DecParamIntf>(mHelper)), deleter);
    ...
    c2_status_t createInterface(
        ...
        *interface = std::shared_ptr<C2ComponentInterface>(
                        new ExynosC2ComponentInterface(COMPONENT_NAME, id, std::make_shared<ExynosC2Mpeg4DecComponent::Mpeg4DecParamIntf>(mHelper)), deleter);

        return C2_OK;
    }

    virtual ~ExynosC2Mpeg4DecFactory() override = default;
...
EXYNOS_EXPORT_REF extern "C" ::C2ComponentFactory* CreateCodec2Factory() {
    return new ExynosC2Mpeg4DecFactory();
}
