 ...
 */
#ifndef EXYNOS_C2_VC1DEC_COMPONENT_H
#define EXYNOS_C2_VC1DEC_COMPONENT_H
...
class ExynosC2Vc1DecComponent : public ExynosC2DecComponent/*, public std::enable_shared_from_this<ExynosC2Vc1DecComponent>*/ {
public:
    class Vc1DecParamIntf;

    ExynosC2Vc1DecComponent(c2_node_id_t id, const std::shared_ptr<Vc1DecParamIntf> &intfImpl);

    ~ExynosC2Vc1DecComponent() {
        mParamIntf.reset();
    }

    /* add function for ExynosC2Vc1DecComponent */
...
private:
    ...
    ExynosC2Vc1DecComponent() = delete;
};
...
#endif // EXYNOS_C2_VC1DEC_COMPONENT_H
