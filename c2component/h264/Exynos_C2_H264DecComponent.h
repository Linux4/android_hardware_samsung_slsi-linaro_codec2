 ...
 */
#ifndef EXYNOS_C2_H264DEC_COMPONENT_H
#define EXYNOS_C2_H264DEC_COMPONENT_H
...
class ExynosC2H264DecComponent : public ExynosC2DecComponent/*, public std::enable_shared_from_this<ExynosC2H264DecComponent>*/ {
public:
    class H264DecParamIntf;

    ExynosC2H264DecComponent(c2_node_id_t id, const std::shared_ptr<H264DecParamIntf> &intfImpl);

    ~ExynosC2H264DecComponent() {
        mParamIntf.reset();
    }

    /* add function for ExynosC2H264DecComponent */
...
private:
    ...
    ExynosC2H264DecComponent() = delete;
};
...
#endif // EXYNOS_C2_H264DEC_COMPONENT_H
