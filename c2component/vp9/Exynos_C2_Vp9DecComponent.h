 ...
 */
#ifndef EXYNOS_C2_VP9DEC_COMPONENT_H
#define EXYNOS_C2_VP9DEC_COMPONENT_H
...
class ExynosC2Vp9DecComponent : public ExynosC2DecComponent/*, public std::enable_shared_from_this<ExynosC2Vp9DecComponent>*/ {
public:
    class Vp9DecParamIntf;

    ExynosC2Vp9DecComponent(c2_node_id_t id, const std::shared_ptr<Vp9DecParamIntf> &intfImpl);

    ~ExynosC2Vp9DecComponent() {
        mParamIntf.reset();
    }

    /* add function for ExynosC2Vp9DecComponent */
...
private:
    ...
    ExynosC2Vp9DecComponent() = delete;
};
...
#endif // EXYNOS_C2_VP9DEC_COMPONENT_H
