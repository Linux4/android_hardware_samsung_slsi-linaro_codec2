 ...
 */
#ifndef EXYNOS_HDR2SDR_FILTER_H
#define EXYNOS_HDR2SDR_FILTER_H
...
class ExynosHDR2SDRFilter : public ExynosExternalFilter {
public:
    ExynosHDR2SDRFilter(uint32_t id, bool isSecure = false);

    ~ExynosHDR2SDRFilter() = default;
